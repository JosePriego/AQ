...
# --- FUNCIONES DE CALLBACK (Sin st.rerun) ---
def aplicar_sugerencia(sugerencia, columna, dataframe):
    """Aplica la sugerencia al buscador principal"""
...
def comprobar_login():
    ...
    # CONTRASEÑA DE ACCESO: Puedes cambiar "biblioteca2026" por la que quieras
...
# ==========================================
    ...
    # Comprobación de seguridad: Si no está autenticado, mostramos el login
    if not st.session_state.autenticado:
        st.info("🔒 Esta zona está restringida al personal de la biblioteca. Por favor, identifícate.")
        
        # Formulario de Login pequeño
    ...
    # Si la contraseña es correcta, mostramos el formulario de catalogación
    else:
